...
#define DR(Format, ...) if (fnConAttrPrintfA)  { FlushFileBuffers(hStdRedirectOut); fnConAttrPrintfA(0xF0, FOREGROUND_RED, Format, __VA_ARGS__); }
...
#define DB(Format, ...) if (fnConAttrPrintfA)  { FlushFileBuffers(hStdRedirectOut); fnConAttrPrintfA(0xF0, FOREGROUND_BLUE, Format, __VA_ARGS__); }
